...
#EL PROGRAMA QUE E UTILIZADO PARA VER LAS RUTAS A SIDO INSOMNIA. 
#YA QUE NO TENEMOS BASE DE DATOS QUE CONTENGA UN FORMULARIO PARA ELIMINAR O AGREGAR CONTENIDO.
